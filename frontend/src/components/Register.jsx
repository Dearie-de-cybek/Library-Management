      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-blue-100 text-sm mb-1" dir="rtl">انضم إلى مجتمعنا</p>
            <p className="text-blue-100 text-xs">Create your Islamic Library account</p>
          </div>
        </div>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                Create My Account
                <span className="text-blue-200 text-xs" dir="rtl">إنشاء حساب</span>
              </>
            )}
          </button>
