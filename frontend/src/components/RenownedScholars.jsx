            ...
            <div className="relative">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
                  <div className="flex items-center gap-2 text-emerald-800">
                    ...
                    <span className="text-sm font-semibold">{scholar.worksCount} أعمال منشورة</span>
                  </div>
                </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    whileHover={{ x: 3 }}
                    className="group/btn text-emerald-700 hover:text-emerald-900 flex items-center gap-2 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 rounded-lg p-2 transition-colors duration-200"
